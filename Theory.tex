...
\[
\text{BER} \approx \frac{4}{\log_2 M} \left(1 - \frac{1}{\sqrt{M}}\right) \frac{1}{2} 
\,\text{erfc}\!\left(\sqrt{\frac{3 \log_2 M}{2(M-1)} \cdot \frac{E_b}{N_0}}\right)
\]
where $E_b/N_0$ is the received energy per bit to noise ratio. As shown in 
