...
\hline
Rows & 3,104,976 \\
Urban sites (cells) & 4 (104) \\
Suburban sites (cells) & 4 (105) \\
Recreational sites (cells) & 4 (81) \\
Cells total & 290 \\
...
To provide a clearer visualization of the dataset, Figure~\ref{fig:U1_vs_R1_daily_max} shows the daily peak downlink data volume across 9 different cells: 3 recreational (R), 3 urban (U), and 3 suburban (S) sites. The figure also reveals a gap in August 2024 due to missing data in the dataset. \\
