...
In addition to the cell-specific OLS models, a global OLS model trained on all cells was evaluated separately on seasonal and non-seasonal subsets to assess performance differences across groups.

The global model achieved an RMSE of 1.47 on seasonal cells and 1.60 on non-seasonal cells.