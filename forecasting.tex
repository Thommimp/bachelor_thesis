...
\begin{tabular}{lccc}
\hline
\textbf{Model} & \textbf{Seasonal} & \textbf{Non-Seasonal} & \textbf{All} \\
\hline
...
\hline
\end{tabular}
\caption{Root Mean Squared Error (RMSE) for baseline forecasting models across different site categories}
