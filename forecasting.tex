...
\begin{table}[htbp]
	...
	\begin{tabular}{lcccccc}
		...
		\bottomrule
	\end{tabular}
	\caption{RMSE and standard deviation (STD) of residuals for baseline forecasting models.}
	\label{tab:baseline_models}
\end{table}

Table~\ref{tab:baseline_models} presents the baseline model results. The seasonal naive model performs worst across all splits, with an RMSE of 2.36 on seasonal cells, 2.58 on non-seasonal cells, and 2.51 overall. This suggests that traffic patterns are not stable year over year. \\
